...
public class AddCustomer extends JFrame {
	...
	public AddCustomer() {
		...
		JLabel add_user_heading = new JLabel("Nhập thông tin khách hàng");
		...
		addButton.setBounds(225, 373, 197, 32);
		...
		cancelButton.setBounds(432, 373, 197, 32);
	...
	public void insertUser() {
		...
		try {
			...
			String sql = 
				"insert into \"User\"(full_name, address, email, \"password\", gender, phone, role_id) values (?,?,?,?,?,?,3)";
